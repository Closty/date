...
<svg xmlns="http://www.w3.org/2000/svg" aria-label="Calendar" role="img" viewBox="0 0 512 512">
    ...
    <text id="month" x="32" y="164" fill="#fff" font-family="monospace" font-size="140px" style="text-anchor: left"><?php echo date("M")?></text>
    <text id="day" x="256" y="400" fill="#333" font-family="monospace" font-size="256px" style="text-anchor: middle"><?php echo date("d")?></text>
    <text id="weekday" x="256" y="480" fill="#66757f" font-family="monospace" font-size="64px" style="text-anchor: middle"><?php echo date("l")?></text></svg>
